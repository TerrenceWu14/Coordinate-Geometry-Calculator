...
custom_file = input("Enter your custom filename or leave it blank for"
                    " a random one generated by us: ")
...
while True:
    ...
    try:
        questions_needed = input("\nHow many questions do you need answered"
                                 " (leave blank for infinite mode)? ")
        if questions_needed == "":
            break
        ...
        print("Please only enter numbers or just leave it blank for infinite mode")
        continue

while questions_needed == "" or question_num <= questions_needed and response != "xxx":
