...
# sets up coordinates to be printed on pandas
coordinates = f"({first_x}, {first_y}), ({second_x}, {second_y})"

# sets up dict
answers = {
    "Filler": "Filler",
    "Answer": [f"Equation:{equation}", f"Midpoint:{midpoint}", f"Distance:{distance}", f"Gradient:{gradient}"],
}
...
pandas_frame = pandas_frame.set_index('Answer')
